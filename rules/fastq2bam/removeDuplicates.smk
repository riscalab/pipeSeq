...
rule removeDuplicates:
    ...
    run:
        ...
        shell("picard CollectInsertSizeMetrics I={input} O={params.histDupsLog} H={params.histDupsPDF} W={params.width} STOP_AFTER={params.stopAfter}")
        # remove duplicates
        print("Removing duplicates")
        shell("picard MarkDuplicates I={input} O={output} METRICS_FILE={params.dupsLog} REMOVE_DUPLICATES=true")
        # histogram without duplicates
        shell("samtools index {output}")
        print("Histogram without duplicates")
        shell("picard CollectInsertSizeMetrics I={output} O={params.histNoDupsLog} H={params.histNoDupsPDF} W={params.width} STOP_AFTER={params.stopAfter}")
